...
applications:
  - name: Ultrasonic Welding
    description: High-speed joining of thermoplastics for electronics, medical, and automotive.
...
We connect these monitoring systems to Cognex or Keyence vision systems for post-weld inspection of flash height, part alignment, and cosmetic appearance. The combination of in-process monitoring and post-weld inspection gives you a reject detection rate approaching 100% — which matters enormously in [medical](/industries/medical/) and automotive safety applications where escapes aren't an option.
